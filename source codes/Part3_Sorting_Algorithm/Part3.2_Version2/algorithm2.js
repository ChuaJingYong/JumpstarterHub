...
function getAllPositions(radius,numberOfComponents){
    // ------PSEUDOCODE---------
    // calculate and store all the possible angles into array
...
function getOffsetRelativePositions (x,y){
    let newX = Math.round(x) + X_SHIFT - OWN_RADIUS_OFFSET + "px"
    let newY= -(Math.round(y) + Y_SHIFT + OWN_RADIUS_OFFSET) + "px"
...
function getNumberOfConnectedChildren(targetComponent){
    ...
    console.log("inner array",arrOfMidComponents)
